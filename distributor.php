...
<body>
    ...
    <form id ="cform" method = "post" action = ""> 
        <div class = "entirec"> <span class = "inputtypes">Name of Contact Person: </span> <input type = "text" class = "contactinput" name = "fname"> </div>
        ...
        <div class = "entirec"><span class = "inputtypes">Drop-off Address:</span> <input type = "text"class = "contactinput" name = "address"></div>
